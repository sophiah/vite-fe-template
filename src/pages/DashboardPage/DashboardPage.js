  ...
  return (
    <Grid container spacing={2.25}>
      <Grid item xs={12} lg={8}>
        <CAppBox title="Welcome back, Product Team" subtitle="Template dashboard page" gradient>
      ...
      <Grid item xs={12} md={7}>
        <CAppBox title="Revenue Updates" subtitle="Overview of profit">
      ...
      <Grid item xs={12} md={5}>
        <CAppBox title="Sales Overview" subtitle="Every month">
